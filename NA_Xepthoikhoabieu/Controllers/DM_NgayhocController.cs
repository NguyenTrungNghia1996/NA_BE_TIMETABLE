...
namespace NA_Xepthoikhoabieu.Controllers
{
    ...
    public class DM_NgayhocController : ControllerBase
    {
        ...
        public DM_NgayhocController(IMapper mapper, IDM_NgayhocRepository Ngayhoc, IClaimHelperRepository claimHelperRepository)
        {
            _mapper = mapper;
            _Ngayhoc = Ngayhoc;
        ...
        public IActionResult GetList_Paging([FromQuery] int PageIndex, [FromQuery] int PageSize, [FromQuery] string search = "")
        {
            ...
            int totalrecord = 0;
            var list = _Ngayhoc.GetList_Paging(PageIndex, PageSize, search,idDonvi, ref totalrecord);
