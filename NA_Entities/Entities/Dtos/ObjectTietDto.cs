...
namespace NA_Entities.Entities.Dtos
{
    ...
    public class ObjectTiet_theoLopDto
    {
        ...
        public List<tkb_theo_lop> ds_chua_xep { get; set; } = new List<tkb_theo_lop>();
    }
    ...
    public class Ds_chua_xep_giaovien
    {
        public int Id_chitiet { get; set; } = 0;
        public int Id_don_vi { get; set; } = 0;
        public int Id_tkb { get; set; } = 0;
    ...
    public class ObjectTiet_theoGVDto
    {
        ...
        public List<tkb_theo_giaovien> ds_chua_xep { get; set; } = new List<tkb_theo_giaovien>();
    }
